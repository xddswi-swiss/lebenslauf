...
// Using public folder paths for Next.js
const cardGLB = "/assets/lanyard/card.glb";
const lanyard = "/assets/lanyard/lanyard.png";

// Removed problematic global JSX override that breaks Next.js
...
export default memo(function Lanyard({
  position = [0, 0, 30],
  gravity = [0, -40, 0],
  fov = 20,
  transparent = true,
