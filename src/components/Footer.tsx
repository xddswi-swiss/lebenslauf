        ...
        <div className="md:col-span-4 space-y-6 text-left">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href="/assets/pdfs/ErenLebensL.pdf" download className="hover:text-[var(--primary)] transition-colors flex items-center gap-1.5 w-fit">
                  <FiDownload className="text-xs" /> {t.footer.resume} (PDF)
                </a>
              </li>
              <li>
                <a href={LINK_GITHUB} target="_blank" rel="noopener noreferrer" className="hover:text-[var(--primary)] transition-colors w-fit block">
                  GitHub
                </a>
              </li>
              <li>
                <a href={LINK_EMAIL} className="hover:text-[var(--primary)] transition-colors w-fit block">
                  E-Mail
                </a>
              </li>
              <li>
                <a href={LINK_WHATSAPP} target="_blank" rel="noopener noreferrer" className="hover:text-[var(--primary)] transition-colors w-fit block">
                  WhatsApp
                </a>
              </li>
            </ul>
